...
from model.demoModel import demoMindConfig
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="demoMind Pretraining")
    ...
    parser.add_argument(
        "--wandb_project", type=str, default="demoMind-Pretrain", help="wandb项目名"
    )
    ...
    if args.use_wandb and is_main_process():
        ...
        # 构建实验名称，包含关键超参数
        wandb_run_name = f"demoMind-Pretrain-Epoch-{args.epochs}-BatchSize-{args.batch_size}-LearningRate-{args.learning_rate}"
        wandb.init(
